...
As the code is available for anyone to access, and since there is a license which clearly states that anyone can contribute to and use the code as they wish, the project can definitely be considered an open source project. As far as we can tell, this project won't replace any proprietary software, as it is hard to find other proprietary projects that are as effective as  Bitfocus Companion. It takes relatively cheap control surfaces and turns it into a higher quality product. For example, Companion does not require an actual streamdeck to be able to use it, as it includes a built in streamdeck emulator, which is hard to find in other open source software. It is also very flexible and user friendly, and we haven't found any other open source projects that work as well as Bitfocus Companion.
